  ...
  public: {
    Tables: {
      ...
      deal_workflow_progress: {
        ...
        Relationships: [
          {
            foreignKeyName: "deal_workflow_progress_completed_by_fkey"
          ...
          {
            foreignKeyName: "deal_workflow_progress_deal_id_fkey"
            columns: ["deal_id"]
            isOneToOne: false
            referencedRelation: "deals"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "deal_workflow_progress_step_definition_id_fkey"
      ...
      deals: {
        ...
        Relationships: [
          {
            foreignKeyName: "deals_active_appointment_id_fkey"
            columns: ["active_appointment_id"]
            isOneToOne: false
      ...
      pricing_configs: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "pricing_configs_office_id_fkey"
            columns: ["office_id"]
            isOneToOne: false
            referencedRelation: "offices"
            referencedColumns: ["id"]
      ...
      workflow_step_definitions: {
        Row: {
          applies_to_deal_types: string[] | null
          company_id: string
          config: Json | null
          created_at: string | null
          description: string | null
        ...
        Relationships: [
          {
            foreignKeyName: "workflow_step_definitions_company_id_fkey"
            columns: ["company_id"]
            isOneToOne: false
            referencedRelation: "companies"
            referencedColumns: ["id"]
    ...
    Views: {
      v_deal_detail: {
        Row: {
          ...
          contact_utility_company: string | null
