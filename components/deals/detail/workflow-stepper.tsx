            ...
            <div className="flex flex-col items-center">
              <button
                ...
                className={cn(
                  ...
                  !isDone && !isCurrent && "border-border bg-muted cursor-default",
                  isActive && isDone && "ring-2 ring-success/30 ring-offset-1 ring-offset-card",
                  isActive && isCurrent && "ring-2 ring-primary/30 ring-offset-1 ring-offset-card",
                )}
            ...
            >
              ...
              <span
                className={cn(
                  ...
                  isActive && !isCurrent && isDone && "text-foreground font-semibold",
                  !isDone && !isCurrent && "text-muted-foreground/40"
                )}
              >
                {step.label}
              ...
              {isDone && (
                <span className="ml-auto text-[10px] font-semibold text-success/70">Done</span>
              )}
              {isCurrent && (
                <span className="ml-auto text-[10px] font-semibold text-primary/70">Current</span>
              )}
            </button>
          </div>
        )
