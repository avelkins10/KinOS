  ...
  return [
    {
      ...
      type: "auto",
      passed: hasDesign,
      detail: hasDesign ? "Aurora" : undefined,
    },
    {
      id: "g2",
    ...
    return (
      <div className="flex flex-col items-center justify-center py-16 text-center">
        ...
        <h3 className="text-xl font-bold text-foreground">
          Submitted to Quickbase
        </h3>
        <p className="mt-2 text-sm text-muted-foreground">
          QB ID: QB-2026-{deal.id.replace("d", "")}4821 {"·"} Feb 8, 2026 at
          2:34 PM
        </p>
    ...
    <div>
        ...
        {gates.map((gate) => (
          <div
            ...
            className={cn(
              ...
              gate.passed ? "border-success/20 bg-success/5" : "border-border",
            )}
          >
            {gate.passed ? (
      ...
      {!allPassed && (
        <p className="mt-2 text-center text-xs text-muted-foreground">
          Complete all {gates.length - passedCount} remaining gate
          {gates.length - passedCount > 1 ? "s" : ""} to enable submission
        </p>
      )}
    </div>
  );
