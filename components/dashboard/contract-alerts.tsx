...
import type { ContractAlert } from "@/lib/actions/dashboard";
            ...
            >
              ...
              <div className="min-w-0 flex-1">
                ...
                <p className="mt-0.5 text-xs opacity-70">
                  ...
                  {alert.daysSinceSent > 0 &&
                    ` · ${alert.daysSinceSent}d ago`}
                </p>
              </div>
            </a>
          );
