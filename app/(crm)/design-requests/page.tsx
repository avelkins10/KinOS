...
const DESIGN_REQUESTS: DesignRequest[] = [
  {
    ...
    address: "4521 E Cactus Rd, Phoenix, AZ",
    status: "in_progress",
    requestedAt: "Feb 7, 2026",
    assignedTo: "Design Team",
    systemSize: 10.66,
    notes: "Standard roof, no obstructions",
  },
  {
    id: "dr2",
    dealId: "d8",
    customer: "Karen & Bill Foster",
    address: "7714 S Dixie Hwy, West Palm Beach, FL",
    status: "completed",
    requestedAt: "Feb 3, 2026",
    assignedTo: "Design Team",
    systemSize: 15.8,
    notes: "Tile roof, need tilt racks on flat section",
  },
  {
    id: "dr3",
    dealId: "d12",
    customer: "Elizabeth Taylor",
    address: "3320 N Central Ave, Phoenix, AZ",
    status: "in_progress",
    requestedAt: "Feb 5, 2026",
    assignedTo: "Design Team",
    systemSize: 11.2,
    notes: "Two-story, panels on south-facing only",
  },
  {
    id: "dr4",
    dealId: "d9",
    customer: "Michael Scott",
    address: "12450 W Indian School Rd, Avondale, AZ",
    status: "pending",
    requestedAt: "Feb 9, 2026",
    assignedTo: "Unassigned",
    systemSize: null,
    notes: "Waiting on site survey photos",
  },
];
  ...
  return (
    <div className="p-6 lg:p-8">
      ...
      <div className="mb-6 grid gap-4 sm:grid-cols-4">
        {(["pending", "in_progress", "completed", "revision"] as const).map(
          (status) => {
            const config = statusConfig[status];
            const Icon = config.icon;
            const count = DESIGN_REQUESTS.filter(
              (r) => r.status === status,
            ).length;
            return (
              <div
                ...
                <div className="flex items-center gap-3">
                  <div
                    className={cn(
                      ...
                      config.classes.split(" ").slice(0, 2).join(" "),
                    )}
                  >
